...
public class cgEstadoHormigaDTO {
    ...
    public cgEstadoHormigaDTO () {}

    public cgEstadoHormigaDTO(Integer IdEstadoHormiga, String nombre, String descripcion, String estado,
